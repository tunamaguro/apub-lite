...
(
    gen_random_uuid(),
    'https://sub1.example.com/users/bob',
    'sub1.example.com',
    'bob',
...
(
    ...
    'sub2.example.com',
    'charlie',
    'https://sub2.example.com/users/charlie/inbox',
    'https://sub2.example.com/inbox'
),
(
    gen_random_uuid(),
    'https://sub3.example.com/~david',
    'sub3.example.com',
    'david',
    'https://sub3.example.com/~david/inbox',
    NULL
),
(
    gen_random_uuid(),
    'https://sub4.example.com/users/erin',
    'sub4.example.com',
    'erin',
    'https://sub4.example.com/users/erin/inbox',
    'https://sub4.example.com/inbox'
);
